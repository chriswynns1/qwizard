...
function TriviaCategoryCard({ category, onClick }) {
  ...
  return (
    <div
      className="border p-4 m-4 rounded-md cursor-pointer text-center animate-slideup transitioninset-0 ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-200 shadow-2xl"
      onClick={onClick}
    >
